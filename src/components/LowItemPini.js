...
function LowItemPini() {
  ...
  let result = pinigines.find(product => product.number === itemId)
  ...
  const saveChart = () => {
    if(inputValue > 10) {
      ...
      navigate(`/items/pinigines/${result.number}`)
    }
  }
              ...
              <div className='itemImageDiv'>
                <div className="carousel-wrapper" id='carouselDiv'>
                  <Carousel infiniteLoop useKeyboardArrows>
                      <div>
                          <img src={require('../images/pinigines/' + result.number + `/${result.datanumber}A.jpg` )} className="itemImage" alt='item to purchase'/>
                      </div>
                      <div>
                          <img src={require('../images/pinigines/' + result.number + `/${result.datanumber}B.jpg` )} className="itemImage" alt='item to purchase'/>
                      </div>
                      <div>
                          <img src={require('../images/pinigines/' + result.number + `/${result.datanumber}C.jpg` )} className="itemImage" alt='item to purchase'/>
                      </div>
                      <div>
                          <img src={require('../images/pinigines/' + result.number + `/${result.datanumber}D.jpg` )} className="itemImage" alt='item to purchase'/>
                      </div>
                  </Carousel>
                </div>
